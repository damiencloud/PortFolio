...
export const aboutContent: AboutContent = {
  sectionLabel: "Overview Dashboard",
  ...
  metrics: [
    { value: 4, suffix: "", label: "Work & Internship Roles" },
    { value: 2, suffix: "", label: "Core Projects" },
    { value: 4, suffix: "", label: "Certifications" }
  ],
  details: [
    { label: "Location", value: "Kochi / Bangalore, India", color: "#60a5fa" },
    { label: "Education", value: "MCA — Kristu Jayanti College", color: "#a78bfa" },
    { label: "Focus", value: "React · Next.js · Django · Supabase", color: "#34d399" },
    { label: "Languages", value: "English, Malayalam, Hindi, Tamil", color: "#fb923c" }
  ]
};
