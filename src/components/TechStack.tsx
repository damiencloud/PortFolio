...
export function TechStack() {
  ...
  return (
    <section id="skills" className="py-24 overflow-hidden relative z-10 border-t border-neutral-100 dark:border-neutral-900 bg-neutral-50/50 dark:bg-neutral-950/20">
